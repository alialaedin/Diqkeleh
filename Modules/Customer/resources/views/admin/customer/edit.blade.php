			...
			<x-row>
				...
				<x-col lg="6" xl="3">
					<x-form-group>
						...
						<x-input type="text" name="first_name" :default-value="$customer->first_name" required autofocus />
					</x-form-group>
				</x-col>
				...
				<x-col lg="6" xl="3">
					<x-form-group>
						...
						<x-input type="text" name="last_name" :default-value="$customer->last_name" required />
					</x-form-group>
				</x-col>
